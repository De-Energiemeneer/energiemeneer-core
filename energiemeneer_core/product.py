...
class Product:
    ...
    offerteregels: str         # "woning" (m²-staffel + productartikelen) | "vve" | "geen"
    ...
    dossiertype: str           # "particulier" | "vve_maatwerk" (later: "vve_scan")
...
CATALOGUS: tuple[Product, ...] = (
    ...
    Product("Energiescan VvE", "energiescan-vve", "Scan VvE", "vve",
            ...
            facturatie="robot", dossiertype="particulier", boom="beide", koepel=False,
